...
import stylesheet from "styles/pages/projectCreate.scss";
        ...
        <div className="createProject">
          ...
          {jurisdiction ? (
            <div className="button">
              {/*<div className="cancel" onClick={()=>{this.props.closedCallBack();Router.push(Dingtalk.setDdNavColor('/mo_project'));}}>取消</div>*/}
              <div
                className={
